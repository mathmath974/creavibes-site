...
export const blogArticles: BlogArticle[] = [
  {
    slug: "automatiser-devis-factures-relances-patente-tahiti",
    title: "Devis, factures, relances : automatiser l'administratif d'un patenté à Tahiti",
    metaTitle: "Automatiser devis et factures à Tahiti | CréaVibes",
    metaDescription: "Devis, factures, relances de paiement : comment un patenté de Tahiti gagne des heures chaque semaine grâce à l'automatisation et à l'IA, sans usine à gaz.",
    excerpt: "Le soir, après le chantier ou la boutique, il reste les devis à envoyer, les factures à faire et les clients à relancer. Voici comment un patenté de Tahiti peut automatiser cet administratif, étape par étape, avec des outils simples et un peu d'IA.",
    date: "2026-09-23",
    image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
    imageAlt: "Mains remplissant une facture avec une calculatrice sur un bureau",
    serviceLink: "/automatisation-ia-tahiti",
    serviceLinkLabel: "Découvrir notre service automatisation IA",
    serviceLinks: [
      { href: "/automatisation-ia-tahiti", label: "Automatisation IA à Tahiti" },
      { href: "/creation-site-internet-tahiti", label: "Création de site internet à Tahiti" },
      { href: "/blog/automatisation-ia-pme-polynesie", label: "Automatisation IA pour PME en Polynésie" },
    ],
    sections: [
      { type: "p", content: "Électricien à Faa'a, paysagiste à Taravao, traiteur à Papeete ou prestataire nautique à Moorea : quand on est patenté au fenua, la journée de travail ne s'arrête pas quand on range les outils. Il reste les devis promis la veille, les factures à envoyer, les acomptes à vérifier et ce client qu'il faudrait relancer depuis trois semaines. Cet administratif grignote les soirées et, trop souvent, il retarde les paiements. La bonne nouvelle : une grande partie peut aujourd'hui être automatisée, sans devenir informaticien." },
      { type: "h2", content: "Pourquoi l'administratif coûte si cher à un patenté" },
      { type: "p", content: "Le temps passé sur les papiers est rarement compté, mais il se paie de trois façons. D'abord en heures : recopier les mêmes informations dans un devis, puis dans une facture, puis dans un tableau de suivi. Ensuite en trésorerie : une facture envoyée avec dix jours de retard, c'est un paiement qui arrive dix jours plus tard. Enfin en chiffre d'affaires : un devis envoyé trop tard, c'est parfois un client qui a déjà signé ailleurs." },
      { type: "h2", content: "Étape 1 : des modèles de devis prêts en deux minutes" },
      { type: "p", content: "La base, c'est un outil de devis et de facturation en ligne plutôt qu'un fichier Word modifié à la main. Vous enregistrez une fois vos prestations, vos tarifs en francs Pacifique et vos conditions (acompte, délais, validité du devis). Ensuite, un devis se compose en quelques clics depuis le téléphone, sur le chantier même, et part par e-mail ou WhatsApp au format PDF." },
      { type: "h3", content: "Le devis qui se transforme en facture" },
      { type: "p", content: "Une fois le devis accepté, il devient facture sans rien ressaisir. Les numéros se suivent automatiquement, les montants sont justes et vous gardez un historique propre, ce que votre comptable appréciera. Pour les mentions obligatoires et la TVA applicable en Polynésie, faites valider vos modèles une fois pour toutes par votre comptable ou votre centre de gestion." },
      { type: "h2", content: "Étape 2 : des relances de paiement qui partent toutes seules" },
      { type: "p", content: "Relancer un client, c'est inconfortable, surtout dans un petit pays où tout le monde se connaît. L'automatisation règle ce problème avec élégance : un rappel courtois part automatiquement quelques jours avant l'échéance, puis un second message si la facture reste impayée. Le ton est poli, régulier, jamais agacé, et vous n'avez plus à y penser." },
      { type: "list", items: [
        "J-3 : un petit rappel amical avec la facture en pièce jointe.",
        "Jour de l'échéance : les informations de paiement (virement, lien de paiement si vous en proposez un).",
        "J+7 : une relance plus directe, toujours courtoise, avec une copie qui vous est adressée pour décider de la suite.",
      ]},
      { type: "h2", content: "Étape 3 : l'IA pour rédiger et trier à votre place" },
      { type: "p", content: "C'est là que l'intelligence artificielle apporte un vrai plus. Un assistant IA peut transformer un message vocal ou une note rapide (« terrasse 20 m², nettoyage haute pression + traitement, accès facile ») en brouillon de devis détaillé que vous n'avez plus qu'à relire. Il peut aussi rédiger un e-mail d'accompagnement clair, en français ou en anglais pour votre clientèle touristique." },
      { type: "p", content: "Autre usage très concret : trier les demandes entrantes. Les messages reçus via votre site, Facebook ou WhatsApp sont classés automatiquement (demande de devis, question sur un délai, réclamation), et les demandes de devis arrivent déjà structurées dans votre tableau de suivi. Votre site internet peut d'ailleurs proposer un formulaire de demande de devis bien pensé, qui récupère d'emblée les bonnes informations." },
      { type: "h3", content: "Garder la main sur l'essentiel" },
      { type: "p", content: "L'IA propose, vous validez. Un devis engage votre entreprise : relisez toujours les quantités, les prix et les délais avant l'envoi. L'objectif n'est pas de tout déléguer à une machine, mais de supprimer la ressaisie et les oublis pour garder votre énergie pour vos clients." },
      { type: "h2", content: "Par où commencer, concrètement ?" },
      { type: "list", items: [
        "Notez pendant une semaine le temps passé sur les devis, factures et relances. Le chiffre surprend souvent.",
        "Commencez par un seul irritant : les relances de paiement sont en général le gain le plus rapide.",
        "Choisissez des outils simples, utilisables sur smartphone, avec un réseau parfois capricieux dans les îles.",
        "Ajoutez l'IA ensuite, une fois vos modèles et vos processus en place.",
      ]},
      { type: "h2", content: "On automatise votre administratif avec vous" },
      { type: "p", content: "Chez CréaVibes, notre service d'automatisation IA à Tahiti met en place ces outils pour les patentés et petites entreprises du fenua : modèles de devis, facturation, relances automatiques, tri des demandes et assistant IA, le tout adapté à votre activité et à votre budget. Réservez un rendez-vous découverte en visio de 30 minutes : c'est gratuit, sans engagement, et on regarde ensemble ce qui peut vous faire gagner du temps dès le mois prochain." },
      { type: "note", content: "Article informatif. Les règles de facturation et de TVA applicables en Polynésie française peuvent évoluer : faites valider vos modèles par votre comptable. CréaVibes ne garantit aucun résultat commercial ou de référencement chiffré." },
    ]
  },
  {
    slug: "fetes-fin-annee-tahiti-communication-digitale-commerces",
    title: "Fêtes de fin d'année à Tahiti : préparer la communication digitale de votre commerce dès octobre",
    metaTitle: "Fêtes de fin d'année à Tahiti : plan digital | CréaVibes",
    metaDescription: "Noël et fin d'année à Tahiti : calendrier Facebook et Instagram, site à jour, réponses automatiques. Le plan mois par mois pour les commerces du fenua.",
    excerpt: "Au fenua, la saison des fêtes commence bien avant décembre. Voici comment un commerce ou un patenté de Tahiti prépare dès octobre ses réseaux sociaux, son site et ses messages clients pour vendre sereinement jusqu'au réveillon.",
    date: "2026-09-21",
    image: "https://images.unsplash.com/photo-1512389142860-9c449e58a543?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
    imageAlt: "Cadeaux de Noël emballés dans du papier kraft avec des branches de sapin",
    ...
    serviceLinks: [
      ...
      { href: "/creation-site-internet-tahiti", label: "Création de site internet à Tahiti" },
      { href: "/blog/idees-publications-facebook-patente-tahiti", label: "Idées de publications Facebook pour patenté" },
    ],
    sections: [
      { type: "p", content: "À Tahiti, les fêtes de fin d'année ne se limitent pas au 24 décembre. Entre les cadeaux achetés à l'avance, les commandes des familles des îles qui s'organisent tôt, les colis à expédier vers Moorea, Raiatea ou les Tuamotu et les repas de Noël et du Nouvel An, la période s'étale de mi-novembre à début janvier. Pour un commerce, un artisan ou un traiteur du fenua, c'est souvent le moment le plus important de l'année. Le piège : s'y prendre le 10 décembre, quand tout le monde publie en même temps. Voici comment préparer votre communication digitale dès octobre." },
      { type: "h2", content: "Pourquoi commencer en octobre au fenua" },
      { type: "p", content: "Les habitudes locales imposent leur calendrier. Beaucoup de familles des îles passent commande dès novembre pour être sûres de recevoir leurs colis par bateau ou par avion avant Noël. Et sur Facebook, la concurrence pour l'attention explose en décembre : plus vous installez tôt vos produits de fête dans la tête de vos abonnés, plus vous récoltez de réservations et de précommandes avant la cohue." },
      { type: "h2", content: "Étape 1 : bâtir un calendrier de publications Facebook et Instagram" },
      { type: "p", content: "Un calendrier éditorial, c'est une simple feuille avec une ligne par publication : date, sujet, visuel, objectif. Pour la saison des fêtes, prévoyez deux à trois publications par semaine à partir de mi-novembre, en alternant les angles." },
      { type: "list", items: [
        "Les coulisses : préparation des produits, emballages, équipe qui s'active. C'est ce qui crée la proximité.",
        "Les offres : coffrets, menus de réveillon, idées cadeaux par budget, cartes cadeaux.",
        "Les informations pratiques : horaires de fin d'année, dates limites de commande, délais d'expédition vers les îles.",
        "Les témoignages et photos de clients, avec leur accord, qui rassurent ceux qui hésitent.",
        "Un compte à rebours ou un jeu-concours léger dans les derniers jours, dans le respect des règles de Meta.",
      ]},
      { type: "h3", content: "Préparer les visuels à l'avance" },
      { type: "p", content: "Le secret d'une saison sans stress, c'est de photographier vos produits de fête en octobre, avec le temps de soigner la lumière. Une dizaine de photos et deux ou trois courtes vidéos alimentent six semaines de publications, que vous programmez ensuite en une après-midi dans Meta Business Suite." },
      { type: "h2", content: "Étape 2 : mettre votre site internet aux couleurs des fêtes" },
      { type: "p", content: "Vérifiez en octobre que votre site est à jour : une page ou une bannière dédiée aux offres de fin d'année, les horaires exceptionnels, la date limite de commande pour une livraison avant Noël et une fiche Google Business Profile cohérente avec ces informations. Si votre site propose la commande ou la réservation en ligne, testez le parcours complet sur téléphone : au fenua, l'immense majorité des visites se fait depuis un smartphone, souvent en 4G. Notre service de création de site internet à Tahiti inclut d'ailleurs ce type de mise à jour saisonnière pour les clients qui nous confient leur site." },
      { type: "h3", content: "Sans site ? Un catalogue simple suffit pour commencer" },
      { type: "p", content: "Un catalogue sur votre page Facebook ou dans WhatsApp Business, avec photos, prix et conditions de commande, dépanne très bien : le client doit trouver en trois secondes ce que vous vendez, combien ça coûte et comment commander." },
      { type: "h2", content: "Étape 3 : anticiper l'avalanche de messages" },
      { type: "p", content: "En décembre, les questions arrivent en rafale : « vous livrez à Paea ? », « c'est possible d'avoir le coffret avant le 20 ? », « vous êtes ouverts le 24 après-midi ? ». Préparez dès maintenant vos réponses enregistrées dans Meta Business Suite et WhatsApp Business : délais, zones de livraison, modes de paiement, horaires des fêtes. Activez un message d'absence qui indique clairement quand vous répondez. Pour les activités qui reçoivent beaucoup de demandes, un assistant IA branché sur la messagerie peut prendre en charge ces questions répétitives, jour et nuit, et vous transmettre uniquement les demandes particulières." },
      { type: "h2", content: "Étape 4 : gérer la logistique dans la communication" },
      { type: "p", content: "En Polynésie, la logistique fait partie du message. Annoncez tôt et répétez souvent la dernière date de commande pour les îles, pour Moorea et pour Tahiti. Un client informé accepte un délai annoncé ; il pardonne rarement un délai découvert trop tard. Épinglez cette publication en haut de votre page et remettez-la à jour chaque semaine." },
      { type: "h2", content: "Étape 5 : prolonger la saison jusqu'en janvier" },
      { type: "p", content: "Beaucoup de commerces se taisent après l'effort de Noël. C'est dommage : un message de vœux sincère, une photo de l'équipe, un merci aux clients et une première annonce pour l'année qui commence entretiennent le lien créé pendant les fêtes. Ces abonnés fidélisés reviendront à la Saint-Valentin, à la fête des mères et au Heiva." },
      { type: "h2", content: "Le plan en résumé" },
      { type: "list", items: [
        "Octobre : photos et vidéos des produits de fête, calendrier de publications, mise à jour du site et de la fiche Google.",
        "Novembre : lancement des offres, précommandes, informations logistiques épinglées.",
        "Décembre : rythme soutenu de publications, réponses rapides grâce aux réponses enregistrées ou à un assistant IA.",
        "Janvier : vœux, remerciements et premières annonces de l'année.",
      ]},
      { type: "p", content: "Vous n'avez pas le temps de tout gérer en pleine saison ? C'est exactement le rôle de notre service de community management à Tahiti : calendrier, visuels, publications et gestion des messages, pendant que vous vous concentrez sur vos produits et vos clients. Réservez un rendez-vous découverte en visio de 30 minutes : c'est gratuit, sans engagement, et vous repartirez avec un plan adapté à votre activité et à votre budget." },
      { type: "note", content: "Article informatif. Les fonctionnalités de Meta Business Suite et de WhatsApp Business évoluent régulièrement. CréaVibes ne garantit aucun résultat commercial ou de référencement chiffré." },
    ]
  },
  {
    slug: "repondre-messages-clients-facebook-instagram-whatsapp-tahiti",
    title: "Messages clients sur Facebook, Instagram et WhatsApp : répondre vite sans y passer sa journée à Tahiti",
    metaTitle: "Répondre aux messages clients à Tahiti | CréaVibes",
    metaDescription: "Messenger, Instagram, WhatsApp : à Tahiti, vos clients vous écrivent. Répondre vite sans y passer la journée : réponses enregistrées, automatisation, IA.",
    excerpt: "Au fenua, un client qui vous écrit sur Messenger, Instagram ou WhatsApp attend une réponse dans l'heure. Voici comment tenir le rythme sans y passer votre journée : organisation, réponses enregistrées, automatisation et IA.",
    date: "2026-09-16",
    image: "https://images.unsplash.com/photo-1577563908411-5077b6dc7624?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
    imageAlt: "Bulle de conversation verte avec trois points sur fond de papiers jaunes",
    serviceLink: "/community-management-tahiti",
    serviceLinkLabel: "Découvrir notre service community management",
    serviceLinks: [
      { href: "/community-management-tahiti", label: "Community management à Tahiti" },
      { href: "/automatisation-ia-tahiti", label: "Automatisation IA pour PME en Polynésie" },
      { href: "/blog/reservation-en-ligne-tahiti-rendez-vous-clients", label: "Réservation en ligne à Tahiti" },
    ],
    sections: [
      { type: "p", content: "À Tahiti, on n'appelle plus, on écrit. « Vous êtes ouverts demain ? », « C'est combien la livraison à Punaauia ? », « Vous avez encore la taille M ? » : ces questions arrivent sur Messenger, en message privé Instagram ou sur WhatsApp, souvent le soir ou le dimanche. Pour un patenté qui gère seul sa boutique, son food truck ou son cabinet, c'est une chance — le client vient à vous — mais aussi une charge invisible qui grignote la journée. Voici comment tenir le rythme sans sacrifier votre temps." },
      { type: "h2", content: "Pourquoi la rapidité de réponse compte autant au fenua" },
      { type: "p", content: "En Polynésie, le bouche-à-oreille fonctionne aussi en messagerie : quand quelqu'un demande dans un groupe « vous connaissez un bon électricien ? », la réponse est « écris-lui sur Messenger, il répond vite ». La réactivité fait partie de votre réputation. Facebook affiche d'ailleurs sur votre page un indicateur du type « Répond généralement en quelques minutes » ou « en une journée » : un visiteur le voit avant même de vous écrire. Un client qui pose une question a une intention d'achat immédiate : répondre dans l'heure, c'est la capter avant qu'elle ne refroidisse." },
      { type: "h2", content: "Regrouper toutes vos conversations au même endroit" },
      { type: "p", content: "Première erreur fréquente : jongler entre l'application Facebook, l'application Instagram et WhatsApp, et en oublier une. Si votre page Facebook et votre compte Instagram professionnel sont reliés, la boîte de réception de Meta Business Suite rassemble les messages et commentaires des deux réseaux dans une seule liste, sur ordinateur comme sur téléphone. WhatsApp Business, de son côté, reste une application séparée, mais elle propose un profil d'entreprise avec horaires et adresse, un catalogue de produits et des étiquettes pour trier vos contacts (nouveau client, commande en cours, à relancer)." },
      { type: "h3", content: "Fixer des créneaux au lieu de répondre en continu" },
      { type: "p", content: "Répondre à chaque notification en temps réel vous interrompt toute la journée. Beaucoup de patentés s'en sortent mieux avec trois créneaux fixes — le matin avant l'ouverture, le midi et en fin de journée — pendant lesquels ils vident la boîte de réception. Entre deux, un message d'absence automatique prévient le client qu'il aura une réponse avant telle heure." },
      { type: "h2", content: "Les réponses enregistrées : votre meilleur gain de temps" },
      { type: "p", content: "Faites l'exercice une semaine : notez les questions qui reviennent. Dans la plupart des activités, cinq à dix questions représentent l'essentiel des messages. Préparez pour chacune une réponse claire, chaleureuse et complète, puis enregistrez-la dans l'outil de votre messagerie (« réponses enregistrées » dans Meta Business Suite, « réponses rapides » dans WhatsApp Business). Un raccourci, deux secondes, et le client reçoit une réponse soignée." },
      { type: "list", items: [
        "Horaires et jours d'ouverture, y compris les jours fériés et les ponts.",
        "Tarifs de base ou fourchette de prix, avec un lien vers votre site pour le détail.",
        "Zones et frais de livraison : Papeete, côte ouest, presqu'île, Moorea, îles.",
        "Disponibilité d'un produit ou d'un créneau, avec la marche à suivre pour réserver.",
        "Modes de paiement acceptés : espèces, carte, virement, paiement en ligne.",
      ]},
      { type: "h2", content: "Automatiser sans devenir un robot" },
      { type: "p", content: "Meta permet de configurer sans coder un message de bienvenue instantané, un message d'absence en dehors de vos horaires et des « questions fréquentes » proposées sous forme de boutons dès l'ouverture de la conversation. Le client obtient immédiatement l'information la plus courante ; vous ne traitez plus que les demandes qui méritent vraiment une réponse humaine. Le bon réglage : automatiser le premier contact, jamais toute la relation." },
      { type: "h3", content: "Et l'IA dans tout ça ?" },
      { type: "p", content: "Pour les entreprises qui reçoivent beaucoup de messages — hébergements, restaurants, prestataires d'activités, commerces en ligne — un assistant IA branché sur votre messagerie va plus loin que les boutons : il comprend une question formulée librement, répond avec les informations de votre entreprise (tarifs, disponibilités, conditions), propose un créneau de réservation et transmet à une personne dès que la demande sort de son périmètre. Bien réglé, il répond à 22 h comme à 6 h, dans le ton de votre entreprise. C'est typiquement ce que nous mettons en place dans nos projets d'automatisation IA pour les PME du fenua, toujours avec une bascule vers l'humain." },
      { type: "h2", content: "Les erreurs qui coûtent des clients" },
      { type: "list", items: [
        "Laisser un message « vu » sans réponse : le client le voit, et il le prend pour un refus.",
        "Répondre uniquement par « en MP » à une question posée en commentaire : répondez publiquement à la partie générale, cela renseigne aussi les autres.",
        "Ne pas relire ses réponses enregistrées : des horaires ou des prix périmés font plus de dégâts qu'une absence de réponse.",
        "Négliger les demandes du week-end : au fenua, beaucoup de décisions d'achat se prennent le samedi.",
      ]},
      { type: "h2", content: "Faire de vos messages un vrai canal de vente" },
      { type: "p", content: "Bien organisée, votre messagerie devient un canal de vente à part entière. Si vous n'avez ni le temps ni l'envie de vous en occuper, c'est précisément ce que couvre notre service de community management : gestion quotidienne des messages et commentaires de votre page Facebook et de votre compte Instagram, réponses enregistrées à vos couleurs et, si besoin, mise en place d'un assistant IA pour absorber les demandes répétitives." },
      { type: "p", content: "Envie de faire le point sur la façon dont vous gérez vos messages clients ? Réservez un rendez-vous découverte en visio de 30 minutes : c'est gratuit, sans engagement, et vous repartirez avec des pistes concrètes adaptées à votre activité." },
      { type: "note", content: "Article informatif. Les fonctionnalités de Meta Business Suite, Messenger, Instagram et WhatsApp Business évoluent régulièrement et peuvent différer selon votre appareil. CréaVibes ne garantit aucun résultat commercial ou de référencement chiffré." },
    ]
  },
  {
  ...
  },
  {
    ...
    serviceLinks: [
      { href: "/community-management-tahiti", label: "Community management à Tahiti" },
      { href: "/blog/booster-publication-facebook-tahiti-publicite", label: "Booster une publication Facebook : quand ça vaut le coup" },
      { href: "/creation-site-internet-tahiti", label: "Création de site internet à Tahiti" },
    ],
    sections: [
      { type: "p", content: "« Est-ce que ma page Facebook sert vraiment à quelque chose ? » C'est une question que beaucoup de patentés du fenua se posent après des mois de publications. La réponse existe, et elle est gratuite : elle se trouve dans les statistiques de votre page. Encore faut-il savoir lesquelles regarder — parce qu'entre la portée, les impressions, les abonnés et les mentions J'aime, Meta affiche des dizaines de chiffres dont la plupart ne vous serviront jamais. Voici comment vous y retrouver en quinze minutes par mois, sans jargon." },
      { type: "h2", content: "Où trouver vos statistiques" },
      { type: "p", content: "Tout se passe dans Meta Business Suite, l'outil gratuit qui pilote votre page Facebook et votre compte Instagram professionnel. Sur ordinateur, rendez-vous sur business.facebook.com puis dans l'onglet « Statistiques ». Sur téléphone, l'application Meta Business Suite propose la même chose en version simplifiée. Si vous publiez depuis l'application Facebook classique, vous avez aussi un aperçu dans « Tableau de bord professionnel », mais la version Business Suite reste la plus complète." },
      { type: "h2", content: "Les trois chiffres qui comptent vraiment" },
      { type: "h3", content: "La portée : combien de personnes vous ont vu" },
      { type: "p", content: "La portée, c'est le nombre de personnes différentes qui ont vu au moins une de vos publications sur une période donnée. C'est votre vitrine numérique : si elle est à zéro, rien d'autre ne peut suivre. Regardez surtout sa tendance sur trois mois plutôt que sa valeur un jour donné — une portée qui monte doucement veut dire que votre page travaille, même si chaque publication prise isolément paraît modeste. Et comparez vos publications entre elles : celles qui portent deux ou trois fois plus que les autres vous indiquent ce que votre clientèle veut voir." },
      { type: "h3", content: "Les interactions : partages et enregistrements d'abord" },
      { type: "p", content: "Toutes les interactions ne se valent pas. Une mention J'aime coûte une demi-seconde ; un partage, lui, signifie que quelqu'un a mis sa propre crédibilité en jeu pour vous recommander à son entourage. À Tahiti, où le bouche-à-oreille reste le premier canal de vente, un partage vaut de l'or : c'est la version numérique du « tu devrais aller voir chez eux ». Les enregistrements racontent la même chose : la personne prévoit de revenir. Quand vous analysez un mois, classez vos publications par partages plutôt que par J'aime — le classement est souvent très différent, et bien plus instructif." },
      { type: "h3", content: "Les messages et les appels : le chiffre qui paie" },
      { type: "p", content: "Le seul indicateur qui remplit réellement le carnet de commandes, c'est le nombre de conversations démarrées : messages Messenger ou Instagram, appels, clics vers votre site ou votre itinéraire. Meta Business Suite les affiche dans les statistiques de messagerie, mais le plus fiable reste votre propre constat : notez chaque semaine combien de demandes de devis ou de réservations sont arrivées « via Facebook ». Si votre portée grimpe mais que les messages stagnent depuis des mois, ce n'est pas un problème de visibilité, c'est un problème de contenu : il attire les regards mais ne donne pas envie d'écrire." },
      { type: "h2", content: "Les chiffres qui flattent l'ego sans remplir le carnet" },
      { type: "list", items: [
        "Le nombre total d'abonnés : un chiffre qui ne dit rien de leur activité ni de leur localisation. Mieux vaut 800 abonnés de Punaauia à Taravao que 8 000 comptes qui ne verront jamais votre local.",
        "Les mentions J'aime seules : agréables, mais peu engageantes. Une publication à 40 J'aime et 0 message n'a rien vendu.",
        "Les vues de vidéo cumulées : Meta compte une vue au bout de quelques secondes à peine. Regardez plutôt la durée moyenne de visionnage.",
        "Les abonnés hors Polynésie : si votre clientèle est locale, une audience internationale gonfle les chiffres sans jamais franchir votre porte.",
      ]},
      { type: "h2", content: "Une routine de quinze minutes par mois" },
      { type: "list", items: [
        "Ouvrez Meta Business Suite et notez trois chiffres : portée du mois, publication la plus partagée, nombre de conversations démarrées.",
        "Comparez avec le mois précédent : ça monte, ça stagne, ça baisse ?",
        "Identifiez votre meilleure publication et demandez-vous pourquoi elle a marché : le sujet, la photo, l'heure, le format ?",
        "Prévoyez deux publications du mois suivant sur ce modèle — on reproduit ce qui marche, on abandonne ce qui ne marche pas.",
        "Une publication a très bien fonctionné naturellement ? C'est la seule qui mérite éventuellement quelques francs de publicité.",
      ]},
      { type: "h2", content: "Les chiffres décident, pas l'intuition" },
      { type: "p", content: "Le vrai bénéfice de cette routine, ce n'est pas de collectionner des tableaux : c'est d'arrêter de publier au hasard. Au bout de trois mois, vous saurez quel jour publier, quels sujets font écrire vos clients et lesquels tombent à plat. Vous publierez peut-être moins — mais mieux, et avec des résultats visibles sur votre activité, pas seulement sur votre écran." },
      { type: "p", content: "Chez CréaVibes, ce suivi fait partie de notre accompagnement community management : chaque mois, nos clients reçoivent un point clair sur ce qui a fonctionné et sur ce qu'on ajuste. Si vous préférez passer ce temps avec vos clients plutôt que dans les tableaux de bord, réservez un rendez-vous découverte en visio de 30 minutes : gratuit, sans engagement, et on regardera ensemble les statistiques de votre page." },
      { type: "note", content: "Article informatif. Les noms des menus et les indicateurs affichés par Meta Business Suite évoluent régulièrement : vérifiez-les directement dans votre outil. CréaVibes ne garantit aucun résultat commercial ou de référencement chiffré." },
    ]
  },
  {
    slug: "reels-videos-courtes-entreprise-tahiti",
    title: "Reels et vidéos courtes : comment s'y mettre quand on tient une petite entreprise à Tahiti",
    metaTitle: "Reels et vidéos courtes à Tahiti | CréaVibes",
    metaDescription: "Vous n'osez pas vous lancer dans les Reels ? Méthode simple pour filmer, monter et publier des vidéos courtes qui font venir des clients à Tahiti.",
    excerpt: "Vous n'osez pas passer à la vidéo ? Le matériel que vous avez déjà, cinq formats qui marchent chez nous et le bon rythme pour tenir dans la durée, sans y passer vos soirées.",
    date: "2026-08-28",
    image: "https://images.unsplash.com/photo-1585829365295-ab7cd400c167?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
    imageAlt: "Téléphone posé sur un trépied en train de filmer, matériel de création de contenu",
    serviceLink: "/community-management-tahiti",
    serviceLinkLabel: "Découvrir notre service community management",
    serviceLinks: [
      { href: "/community-management-tahiti", label: "Community management à Tahiti" },
      { href: "/blog/instagram-entreprise-tahiti-guide-debutant", label: "Instagram pour une entreprise à Tahiti : le guide débutant" },
      { href: "/creation-site-internet-tahiti", label: "Création de site internet à Tahiti" },
    ],
    sections: [
      { type: "p", content: "Une vidéo de vingt secondes filmée au téléphone devant votre local touche aujourd'hui plus de monde qu'une belle photo longuement travaillée. C'est la réalité de Facebook et d'Instagram depuis quelques années, et beaucoup de patentés du fenua le savent — sans oser s'y mettre, faute de temps ou par crainte de mal faire. Voici une méthode simple pour démarrer sans y passer vos soirées." },
      { type: "h2", content: "Pourquoi la vidéo courte est devenue incontournable" },
      { type: "p", content: "Les Reels sont le format que Meta met le plus en avant dans le fil d'actualité. Concrètement, une vidéo courte est proposée à des personnes qui ne vous suivent pas encore, alors qu'une photo est surtout montrée à vos abonnés. Pour une petite entreprise qui cherche à se faire connaître localement, c'est toute la différence entre parler à ses clients actuels et rencontrer les suivants." },
      { type: "p", content: "L'autre avantage est plus humain : la vidéo montre votre visage, votre voix, votre atelier, votre façon de travailler. À Tahiti, où beaucoup de décisions passent par le bouche-à-oreille et la confiance, ce format fait un travail que la plus belle photo ne fera jamais." },
      { type: "h2", content: "Le matériel : vous l'avez déjà" },
      { type: "list", items: [
        "Votre téléphone : n'importe quel smartphone des cinq dernières années filme largement assez bien pour les réseaux sociaux.",
        "La lumière du jour : filmez près d'une ouverture, sous une varangue ou dehors en fin de matinée. Évitez le plein soleil de midi, qui écrase les visages.",
        "Un appui : un muret, un carton, ou un petit trépied à quelques milliers de francs. Une image stable fait immédiatement plus sérieux.",
        "Le son : parlez près du téléphone et éloignez-vous du bord de route ou du ventilateur. Un son mal capté fait décrocher plus vite qu'une image moyenne.",
        "Le montage : l'application Instagram, CapCut ou l'éditeur intégré de votre téléphone suffisent pour couper, sous-titrer et poser une musique.",
      ]},
      { type: "h2", content: "Cinq formats qui fonctionnent chez nous" },
      { type: "h3", content: "Le geste métier" },
      { type: "p", content: "Filmez trente secondes de ce que vous faites tous les jours : le pliage d'un tissu, la préparation d'un plat, la pose d'un carrelage, le nettoyage d'une coque. Ce qui vous paraît banal fascine ceux qui ne connaissent pas votre métier." },
      { type: "h3", content: "L'avant / après" },
      { type: "p", content: "Un terrain débroussaillé, une pièce repeinte, une voiture lavée, une coiffure terminée. Deux plans, une transition, et vous avez démontré votre valeur sans avoir dit un mot sur vos tarifs." },
      { type: "h3", content: "La réponse à une question fréquente" },
      { type: "p", content: "Reprenez les questions qui reviennent en message privé : délais, communes desservies, entretien du produit, ce qui est compris dans la prestation. Une question, une vidéo. Vous répondez une fois pour toutes et vous récupérez du temps chaque semaine." },
      { type: "h3", content: "La personne derrière l'entreprise" },
      { type: "p", content: "Présentez-vous, ou présentez votre équipe. En Polynésie, on aime savoir à qui on a affaire avant d'appeler. C'est souvent le type de vidéo qui rapporte le plus de messages." },
      { type: "h3", content: "Le lieu" },
      { type: "p", content: "Un tour rapide de votre boutique, de votre pension ou de votre stand sur le marché, avec l'information pratique la plus demandée : où se garer, comment vous trouver, les horaires du samedi." },
      { type: "h2", content: "Trois règles qui changent tout" },
      { type: "list", items: [
        "Les trois premières secondes décident du reste : commencez par l'image ou la phrase la plus forte, jamais par un générique ni par un long bonjour.",
        "Sous-titrez systématiquement : une grande partie des vidéos sont regardées sans le son, dans une file d'attente ou au bureau.",
        "Terminez par une action claire : « envoyez-nous un message », « le lien est dans la bio », « passez nous voir à Papeete ». Sans cela, la vidéo divertit mais ne vend pas.",
      ]},
      { type: "h2", content: "Le rythme : régulier plutôt qu'intense" },
      { type: "p", content: "Une vidéo par semaine tenue pendant trois mois vaut mieux que six vidéos en une semaine puis plus rien. Le plus simple : bloquez une heure tous les quinze jours pour filmer trois ou quatre séquences d'un coup, puis publiez-les au fil des jours." },
      { type: "p", content: "Côté horaire, la fin de journée fonctionne bien, quand le fenua sort du travail et reprend son téléphone. Testez, regardez vos statistiques et gardez le créneau qui marche chez vous. Bonne nouvelle : une vidéo utile continue souvent d'être diffusée plusieurs jours après sa publication, le travail fourni n'est donc pas perdu le lendemain." },
      { type: "h2", content: "Ce qu'il faut regarder dans les statistiques" },
      { type: "list", items: [
        "La rétention : combien de personnes regardent au-delà des trois premières secondes ?",
        "Les partages et les enregistrements, meilleurs signaux que les mentions J'aime : ce sont eux qui font sortir la vidéo de votre cercle habituel.",
        "Les messages privés et les appels reçus dans les jours qui suivent — le seul chiffre qui paie vos factures.",
        "L'origine des nouveaux abonnés : viennent-ils de Polynésie, ou d'un peu partout ? Une audience lointaine flatte l'ego, pas le chiffre d'affaires.",
      ]},
      { type: "p", content: "Dernier point, souvent oublié : si vos vidéos renvoient vers votre site, vérifiez qu'il s'ouvre vite sur un téléphone en 4G. Une personne venue d'un Reel n'attend pas cinq secondes." },
      { type: "p", content: "Chez CréaVibes, nous accompagnons des entreprises du fenua sur leurs pages Facebook et Instagram, du calendrier de publication au montage des vidéos courtes. Si vous ne savez pas par où commencer, réservez un rendez-vous découverte en visio de 30 minutes : gratuit, sans engagement, et vous repartirez avec trois idées de vidéos adaptées à votre activité." },
      { type: "note", content: "Article informatif. Les formats proposés par Meta, la durée maximale des Reels et les statistiques disponibles évoluent régulièrement : vérifiez-les directement dans votre application. CréaVibes ne garantit aucun résultat commercial ou de référencement chiffré." },
    ]
  },
  {
    slug: "booster-publication-facebook-tahiti-publicite",
    title: "Booster une publication Facebook à Tahiti : quand ça vaut le coup",
    metaTitle: "Booster une publication Facebook à Tahiti | CréaVibes",
    metaDescription: "Faut-il payer pour booster vos publications Facebook à Tahiti ? Les cas où ça vaut le coup, ceux où c'est de l'argent perdu, et comment bien régler.",
    excerpt: "Le petit bouton bleu « Booster » est tentant. Parfois il fait vraiment décoller une publication, souvent il vide votre budget sans rien changer. Voici comment faire la différence.",
    date: "2026-08-26",
    image: "https://images.unsplash.com/photo-1611162618071-b39a2ec055fb?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
    imageAlt: "Écran de téléphone affichant les applications de réseaux sociaux",
    serviceLink: "/community-management-tahiti",
    serviceLinkLabel: "Découvrir notre service community management",
    serviceLinks: [
      { href: "/community-management-tahiti", label: "Community management à Tahiti" },
      { href: "/creation-site-internet-tahiti", label: "Création de site internet à Tahiti" },
      { href: "/blog/idees-publications-facebook-patente-tahiti", label: "Des idées de publications Facebook quand on est patenté" },
    ],
    sections: [
      { type: "p", content: "Vous publiez une belle photo de votre nouvelle prestation, et Facebook vous propose aussitôt le petit bouton bleu : « Booster la publication ». Quelques milliers de francs, promet-il, et beaucoup plus de monde la verra. Alors on essaie une fois. Puis une deuxième. Et six mois plus tard, on ne sait toujours pas si ça a servi à quelque chose." },
      { type: "h2", content: "Ce que fait réellement le bouton « Booster »" },
      { type: "p", content: "Booster, c'est acheter de la diffusion pour une publication qui existe déjà sur votre page. Facebook la montre à des personnes qui ne vous suivent pas encore, selon la zone, l'âge et les centres d'intérêt que vous indiquez, tant que votre budget dure. C'est la version simplifiée de la publicité Meta : peu de réglages, peu d'objectifs, des statistiques basiques." },
      { type: "p", content: "Le point important : le boost augmente le nombre de personnes touchées, pas la qualité de votre publication. Si le message ne convainc pas gratuitement, il ne convaincra pas davantage en payant — il décevra simplement plus de monde." },
      { type: "h2", content: "Les trois cas où booster est une bonne idée" },
      { type: "h3", content: "Une publication qui fonctionne déjà toute seule" },
      { type: "p", content: "C'est de loin le meilleur usage. Regardez vos publications des dernières semaines : celle qui a récolté le plus de commentaires, de partages et de messages privés a prouvé qu'elle parlait à votre clientèle. Boostez celle-là. Vous mettez de l'argent derrière quelque chose de validé, pas derrière une intuition." },
      { type: "h3", content: "Une échéance courte et locale" },
      { type: "p", content: "Ouverture d'un local, opération spéciale, dernières places pour une sortie du week-end, présence sur un marché : quand l'information a une date limite, la diffusion naturelle est trop lente et trop aléatoire. Un boost ciblé sur les communes concernées fait le travail en quelques jours." },
      { type: "h3", content: "Une activité toute neuve" },
      { type: "p", content: "Une page qui démarre a peu d'abonnés, donc presque aucune portée naturelle. Un budget modeste les premières semaines permet d'amorcer la pompe, à condition de continuer à publier régulièrement à côté." },
      { type: "h2", content: "Les cas où vous jetez votre argent" },
      { type: "list", items: [
        "Booster pour « faire quelque chose » un mois creux, sans objectif ni message précis : vous achetez des vues, pas des clients.",
        "Booster un post sans appel à l'action : la personne trouve ça sympa, puis passe au contenu suivant et vous oublie.",
        "Booster vers un site lent, mal affiché sur téléphone ou sans page dédiée : vous payez pour envoyer des visiteurs vers une porte fermée.",
        "Booster alors que vous ne répondez pas aux messages sous 24 h : l'intérêt créé retombe avant votre réponse.",
        "Booster en laissant le ciblage par défaut, qui inclut souvent des zones ou des profils qui ne pourront jamais venir chez vous.",
      ]},
      { type: "h2", content: "La Polynésie change les règles du jeu" },
      { type: "p", content: "Au dernier recensement, la Polynésie française comptait 278 786 habitants, dont environ 210 000 aux Îles du Vent. Votre audience potentielle est donc petite, et cela a deux conséquences concrètes." },
      { type: "p", content: "D'abord, vous faites vite le tour : les mêmes personnes revoient votre publicité plusieurs fois en quelques jours, et passé un certain point vous payez pour lasser. Mieux vaut des campagnes courtes et espacées qu'un boost qui tourne trois semaines d'affilée." },
      { type: "p", content: "Ensuite, un ciblage trop fin n'a pas de sens ici : empiler les critères jusqu'à une audience de 2 000 personnes fait grimper le coût sans rien améliorer. Une zone cohérente, une tranche d'âge large et un ou deux centres d'intérêt suffisent." },
      { type: "h2", content: "Les trois réglages qui comptent vraiment" },
      { type: "h3", content: "La zone" },
      { type: "p", content: "Sélectionnez les communes réellement atteignables pour votre activité. Un snack de Papeete n'a aucun intérêt à payer pour être vu à Raiatea ; une pension de Moorea, si. Et si vous visez les visiteurs, ciblez aussi les personnes en voyage plutôt que les seuls résidents." },
      { type: "h3", content: "L'objectif" },
      { type: "p", content: "Facebook vous demandera ce que vous cherchez : des messages, des visites sur votre site, des appels. Choisissez l'action que vous voulez vraiment déclencher, pas « plus d'interactions » par défaut : l'algorithme optimise littéralement ce que vous lui demandez." },
      { type: "h3", content: "Le budget et la durée" },
      { type: "p", content: "Un budget quotidien modeste sur cinq à sept jours vaut mieux qu'une grosse somme sur une seule journée : la diffusion a le temps de se calibrer et vous obtenez des chiffres exploitables. Fixez toujours une date de fin — un boost oublié continue de dépenser." },
      { type: "h2", content: "Boost simple ou gestionnaire de publicités ?" },
      { type: "p", content: "Pour une annonce ponctuelle, le boost depuis la page suffit. Dès que vous dépensez régulièrement, le gestionnaire de publicités Meta devient plus intéressant : comparer plusieurs versions d'une annonce, suivre les demandes reçues, reparler aux personnes déjà venues sur votre site. C'est plus technique, mais c'est là que se joue la différence entre « faire de la pub » et piloter un budget." },
      { type: "h2", content: "Ce qu'il faut regarder après la campagne" },
      { type: "list", items: [
        "Combien de messages privés, d'appels ou de réservations sont arrivés pendant la période ?",
        "Combien vous a coûté chacune de ces demandes, budget total divisé par le nombre de contacts ?",
        "Les commentaires viennent-ils de personnes de votre zone, ou d'un peu partout ?",
        "Avez-vous gagné des abonnés qui restent, ou juste des vues sans suite ?",
      ]},
      { type: "p", content: "Notez ces chiffres quelque part, même dans un simple carnet. Au bout de trois ou quatre campagnes, vous saurez ce qui fonctionne chez vous, et vous arrêterez de deviner." },
      { type: "p", content: "Chez CréaVibes, nous gérons les pages Facebook et Instagram d'entreprises du fenua et nous accompagnons celles qui veulent mettre un budget derrière leurs publications — en commençant toujours par vérifier que le contenu et la page d'arrivée tiennent la route." },
      { type: "p", content: "Vous hésitez à investir dans la publicité ? Réservez un rendez-vous découverte en visio de 30 minutes : gratuit, sans engagement, et vous repartirez avec un avis clair sur votre cas." },
      { type: "note", content: "Article informatif. Les fonctionnalités publicitaires de Meta, les objectifs proposés et les options de ciblage évoluent régulièrement : vérifiez-les directement dans votre interface. CréaVibes ne garantit aucun résultat commercial ou de référencement chiffré.", source: { label: "Source : ISPF — Recensement de la population 2022", url: "https://www.ispf.pf/publication/1418" } },
    ]
  },
  {
    slug: "reservation-en-ligne-tahiti-rendez-vous-clients",
    title: "Réservation en ligne à Tahiti : et si vos clients réservaient sans vous appeler ?",
    metaTitle: "Réservation en ligne à Tahiti : le guide | CréaVibes",
    metaDescription: "Pensions, prestataires, salons : pourquoi et comment mettre en place la réservation en ligne à Tahiti, sans perdre le contact humain avec vos clients.",
    excerpt: "Vous répondez encore à vos demandes de réservation entre deux clients, par Messenger et par téléphone ? Il existe plus simple — pour vous comme pour eux.",
    date: "2026-08-19",
    image: "https://images.unsplash.com/photo-1506784983877-45594efa4cbe?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
    imageAlt: "Agenda ouvert posé sur un bureau à côté d'un téléphone et d'un ordinateur portable",
    serviceLink: "/creation-site-internet-tahiti",
    serviceLinkLabel: "Découvrir notre service création de site internet",
    serviceLinks: [
      { href: "/creation-site-internet-tahiti", label: "Création de site internet à Tahiti" },
      { href: "/creation-application-polynesie", label: "Applications mobiles et web en Polynésie" },
      { href: "/blog/creation-boutique-en-ligne-tahiti-e-commerce", label: "Boutique en ligne à Tahiti : par où commencer ?" },
    ],
    sections: [
      { type: "p", content: "Il est 19 h, vous fermez et vous ouvrez Messenger : quatorze messages. Trois demandes de disponibilité pour samedi, deux personnes qui veulent décaler, une qui a finalement réservé ailleurs faute de réponse assez rapide. Si cette scène vous parle, le problème n'est pas votre organisation : c'est que vous faites à la main un travail qu'un système peut faire tout seul, 24 heures sur 24." },
      { type: "h2", content: "Le vrai coût du « appelez-moi pour réserver »" },
      { type: "p", content: "Demander à un client d'appeler, c'est lui demander un effort au moment précis où il est le plus décidé. Or il vous écrit souvent le soir, le dimanche, ou depuis un autre fuseau horaire. Un voyageur qui prépare son séjour depuis Los Angeles ou Paris ne va pas attendre le lendemain matin heure de Tahiti (UTC-10) pour savoir si vous avez de la place : il ouvre l'onglet suivant." },
      { type: "p", content: "À cela s'ajoute le temps que vous y passez vraiment. Les allers-retours pour trouver un créneau, les confirmations, les rappels de la veille, les annulations à replacer : mis bout à bout, c'est facilement plusieurs heures par semaine de travail non facturé." },
      { type: "h2", content: "Ce que la réservation en ligne change concrètement" },
      { type: "h3", content: "Vos clients réservent quand ils y pensent" },
      { type: "p", content: "Un agenda en ligne montre vos disponibilités réelles et laisse le client choisir. Pas d'attente, pas de négociation par messages. La décision se prend au moment où l'envie est là — et c'est précisément à ce moment-là qu'elle se transforme en réservation." },
      { type: "h3", content: "Vous arrêtez de jouer au standardiste" },
      { type: "p", content: "Vous ne répondez plus à « vous avez quelque chose vendredi ? », mais aux questions qui demandent vraiment votre expertise. Le reste se règle sans vous, et votre agenda se remplit pendant que vous travaillez." },
      { type: "h3", content: "Vous réduisez les oublis" },
      { type: "p", content: "La plupart des systèmes envoient une confirmation immédiate puis un rappel automatique la veille, par e-mail ou SMS. Ce simple rappel évite une bonne partie des rendez-vous manqués par simple oubli." },
      { type: "h2", content: "Quelle solution pour quelle activité ?" },
      { type: "p", content: "« Réservation en ligne » ne veut pas dire la même chose selon le métier. Voici les grandes familles de besoins que l'on rencontre au fenua :" },
      { type: "list", items: [
        "Pension, hébergement, location : calendrier de disponibilités par nuitée, acompte en ligne, et surtout synchronisation avec les plateformes de réservation pour éviter les doubles réservations.",
        "Prestataire d'activités (excursion, plongée, sortie bateau) : créneaux horaires, nombre de places restantes, seuil minimum de participants, et conditions d'annulation météo affichées noir sur blanc.",
        "Salon, institut, praticien, garage : prise de rendez-vous par prestation et par intervenant, avec des durées différentes selon le service et un rappel la veille.",
        "Snack, restaurant, traiteur : réservation de table ou commande à emporter avec créneau de retrait, ce qui lisse les pics de midi.",
      ]},
      { type: "h2", content: "Trois questions à trancher avant de vous lancer" },
      { type: "h3", content: "Demandez-vous un acompte ?" },
      { type: "p", content: "C'est la question qui change tout. L'acompte en ligne filtre les réservations fantômes et sécurise votre planning, mais il suppose une solution de paiement — les banques du fenua en proposent, avec des frais et des délais à vérifier auprès de la vôtre. Si vous n'êtes pas prêt, commencez sans : mieux vaut un système simple en service qu'un projet parfait jamais lancé." },
      { type: "h3", content: "Outil du marché ou système intégré ?" },
      { type: "p", content: "Soyons honnêtes : pour beaucoup d'activités, un outil du marché branché sur votre site fait très bien le travail, pour un abonnement mensuel modeste et une mise en place rapide. Le sur-mesure se justifie quand votre logique métier sort du cadre : tarifs saisonniers, transferts inclus, gestion de flotte, plusieurs sites, ou quand la réservation doit dialoguer avec votre outil de gestion." },
      { type: "h3", content: "Qui garde la main sur l'agenda ?" },
      { type: "p", content: "Le point que l'on oublie systématiquement. Si vous prenez aussi des clients au comptoir ou par téléphone, ces créneaux doivent bloquer l'agenda en ligne immédiatement, sinon vous vendrez deux fois la même place. Prévoyez aussi le blocage des congés et des jours fériés — depuis votre téléphone, en trois secondes." },
      { type: "h2", content: "Le piège : le formulaire qui ne réserve rien" },
      { type: "p", content: "Attention à la fausse bonne solution. Un formulaire « demande de réservation » qui vous envoie un simple e-mail n'est pas un système de réservation : le client repart sans savoir s'il a une place, et vous devez toujours le rappeler. Vous avez déplacé le travail, pas supprimé." },
      { type: "p", content: "Autre écueil : le tunnel trop long. Chaque champ obligatoire fait perdre du monde, surtout sur mobile. Le nom, le contact, le créneau : le reste peut attendre." },
      { type: "h2", content: "Et le contact humain, dans tout ça ?" },
      { type: "p", content: "C'est l'objection que l'on entend le plus souvent, et elle est légitime : au fenua, la relation compte autant que la prestation. Mais la réservation en ligne ne remplace pas la relation, elle absorbe l'administratif. Le téléphone reste là pour ceux qui préfèrent, et vous arrivez au rendez-vous avec le nom du client et sa demande déjà sous les yeux. Le contact humain n'y perd rien : il commence mieux préparé." },
      { type: "p", content: "Chez CréaVibes, nous intégrons la réservation directement dans les sites internet que nous créons, ou nous développons un module sur mesure quand l'activité le demande — rappels automatiques, version mobile et, si besoin, paiement de l'acompte. Selon la nature de votre projet, l'Aide à la Création Numérique du Pays peut en financer une partie." },
      { type: "p", content: "Vous voulez savoir si votre activité s'y prête ? Réservez un rendez-vous découverte en visio de 30 minutes : c'est gratuit, sans engagement, et vous repartirez avec une recommandation claire." },
      { type: "note", content: "Article informatif. Les solutions de réservation, les frais de paiement en ligne et les conditions des dispositifs d'aide évoluent : vérifiez-les auprès de votre banque et de la DGEN. CréaVibes ne garantit aucun résultat commercial ou de référencement chiffré.", source: { label: "Source officielle : DGEN — Aide à la Création Numérique", url: "https://www.service-public.pf/dgen/aide-a-la-creation-numerique-acn/" } },
    ]
  },
  {
